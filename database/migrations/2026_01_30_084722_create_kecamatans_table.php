...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('kecamatans', function (Blueprint $table) {
            ...
            // PERBAIKAN: Tambahkan nullable() agar bisa menerima nilai null
        ...
        // Memasukkan data awal dengan kode wilayah lengkap (Kabupaten Tegal, Jawa Tengah)
        DB::table('kecamatans')->insert([
            ['id' => 1, 'nama_kecamatan' => 'ADIWERNA', 'kode_wilayah' => '33.28.11', 'status' => 'aktif'],
            ['id' => 2, 'nama_kecamatan' => 'BALAPULANG', 'kode_wilayah' => '33.28.04', 'status' => 'aktif'],
            ...
            ['id' => 5, 'nama_kecamatan' => 'DUKUHTURI', 'kode_wilayah' => '33.28.12', 'status' => 'aktif'],
            ['id' => 6, 'nama_kecamatan' => 'DUKUHWARU', 'kode_wilayah' => '33.28.10', 'status' => 'aktif'],
            ...
            ['id' => 11, 'nama_kecamatan' => 'LEBAKSIU', 'kode_wilayah' => '33.28.09', 'status' => 'aktif'],
            ['id' => 12, 'nama_kecamatan' => 'MARGASARI', 'kode_wilayah' => '33.28.03', 'status' => 'aktif'],
            ['id' => 13, 'nama_kecamatan' => 'PAGUYANGAN', 'kode_wilayah' => '33.28.05', 'status' => 'aktif'],
            ['id' => 14, 'nama_kecamatan' => 'PANGKAH', 'kode_wilayah' => '33.28.08', 'status' => 'aktif'],
            ['id' => 15, 'nama_kecamatan' => 'SLAWI', 'kode_wilayah' => '33.28.14', 'status' => 'aktif'],
            ['id' => 16, 'nama_kecamatan' => 'SURADADI', 'kode_wilayah' => '33.28.17', 'status' => 'aktif'],
            ['id' => 17, 'nama_kecamatan' => 'TALANG', 'kode_wilayah' => '33.28.13', 'status' => 'aktif'],
            ['id' => 18, 'nama_kecamatan' => 'TARUB', 'kode_wilayah' => '33.28.11', 'status' => 'aktif'],
