        ...
        <main class="flex-1 p-4 md:p-8 w-full overflow-x-hidden">
            ...
            <div x-data="{ 
                ...
                <div x-show="tab === 'dashboard'" x-transition x-cloak
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10"> {{-- Gap grid
                            diperbesar --}}
                            @php
                            ...
                            @foreach($targetKategori as $key => $style)
                                ...
                                <div class="flex flex-col gap-4"> {{-- Gap antar komponen diperbesar --}}
                                    <div @if($notif) @click="selectedNotif = { 
                                        ...
                                        {{-- Padding dinaikkan (p-7 md:p-8), rounded lebih bulat, border dipertebal --}}

                                        <div class="relative z-10">
                                            <div class="flex items-center justify-between mb-6"> {{-- Margin bawah
                                                diperbesar --}}
                                                <div
                                                    ...
                                                    {{-- Wadah icon diperbesar (w-16 h-16) dan ukuran icon (text-3xl) --}}
                                                    <i
                                            ...
                                            <h3
                                                ...
                                                {{-- Label kategori diperbesar (text-[13px]) --}}
                                                {{ $style['label'] }}
                                            </h3>

                                            <div class="min-h-[60px]"> {{-- Min-height diperbesar --}}
                                                @if($hasResponse)
                                                    <p
                                                        class="{{ $isRejected ? 'text-red-800' : 'text-emerald-800' }} font-bold text-[15px] line-clamp-2 leading-relaxed">
                                                        {{-- Ukuran teks tanggapan diperbesar (text-[15px]) --}}
                                                        {{ $tanggapanRaw }}
                                                    </p>
                                                @elseif($notif)
                                                    <p
                                            ...
                                            <div
                                                ...
                                                {{-- Margin top & padding top diperbesar --}}
                                                @if($notif)
                                                    <div
                                    ...
                                    @if($riwayatKategori->count() > 1)
                                        <div
                                            ...
                                            {{-- Riwayat list lebih lebar dan tinggi --}}
                                            @foreach($riwayatKategori->skip(1)->take(5) as $hist)
                                                    ...
                                                    icon: '{{ $style['icon'] }}'
                                                        ...
                                                        <div class="flex items-center gap-3">
                                                            ...
                                                            <span
                                                                class="font-black text-slate-600">{{ $dtHist->format('d/m/Y') }}</span>
                                                        </div>
                                                        <span
                            ...
                            <div x-show="showDetail" x-transition:enter="transition ease-out duration-300"
                                ...
                                <div class="p-8">
                                    <div class="flex justify-between items-center mb-6">
                                        <div class="flex items-center gap-4"> {{-- Gap diperbesar --}}
                                            <div :class="selectedNotif.color ? selectedNotif.color.replace('text', 'bg').replace('600', '100') + ' ' + selectedNotif.color : 'bg-slate-100 text-slate-600'"
                                                ...
                                                {{-- Ukuran icon & box diperbesar --}}
                                                <i class="fas" :class="selectedNotif.icon"></i>
                                            </div>
                                            <div>
                                                <h4 class="text-slate-800 font-black text-xl leading-tight">Detail
                                                    Laporan</h4> {{-- Text diperbesar --}}
                                    ...
                                    <div class="space-y-5"> {{-- Space diperbesar --}}
                                        <div class="grid grid-cols-1 gap-3">
                                            {{-- Kategori Masalah --}}
                                            <template
                                                x-if="selectedNotif.kategori_asli || selectedNotif.group_key === 'LUAR_CARD'">
                                                <div class="px-5 py-4 bg-blue-50 border border-blue-100 rounded-2xl">
                                                    <p
                                                    ...
                                                    {{-- Dari text-xs ke text-sm --}}
                                                </div>
                                            </template>

                                            {{-- Jenis Layanan / Dokumen --}}
                                            <template x-if="selectedNotif.jenis_layanan || selectedNotif.jenis_dokumen">
                                                <div
                                        ...
                                        <div class="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                                            <div class="flex justify-between items-start mb-3">
                                                <p class="text-xs font-black text-slate-400 uppercase">Deskripsi /
                                                    Pesan:</p> {{-- Dari 9px ke text-xs --}}
                                                <span class="text-xs text-slate-500 font-bold"
                                                    x-text="selectedNotif.full_date"></span> {{-- Dari 7px ke
                                                text-xs --}}
                                            </div>
                                            <p class="text-slate-700 text-base font-semibold italic leading-relaxed"
                                                x-text="selectedNotif.pesan"></p> {{-- Dari text-sm ke text-base
                                            --}}
                                        </div>
                                        ...
                                        <div :class="selectedNotif.status === 'Ditolak' ? 'bg-red-900 border-red-500' : 'bg-slate-900 border-orange-500'"
                                            ...
                                            <p class="text-xs font-black uppercase mb-3 relative z-10 opacity-70"
                                                ...
                                                Balasan Petugas:
                                            </p> {{-- Dari 9px ke text-xs --}}
                                            <p class="text-sm md:text-base leading-relaxed relative z-10 font-medium"
                                                x-text="selectedNotif.tanggapan"></p> {{-- Dari 13px ke text-base
                                            --}}
                                            ...
                                            <div
                                                ...
                                                <template x-if="selectedNotif.has_response">
                                                    <span class="text-xs text-white font-bold uppercase"
                                                        x-text="selectedNotif.update_date"></span> {{-- Dari 9px ke
                                                    text-xs --}}
                                                </template>
                                                <span
                                                    class="px-3 py-1.5 bg-white/10 rounded-lg text-[10px] font-black uppercase tracking-normal"
                                                    x-text="selectedNotif.status"></span> {{-- Dari 7px ke 10px --}}
                                            </div>
                                    ...
                                    <button @click="showDetail = false"
                                        ...
                                        Tutup
                                    </button> {{-- Padding dan text diperbesar --}}
                                </div>
                            </div>
                        </div>
                    </template>
                ...
                handleFiles(event) {
                    ...
                    files.forEach(file => {
                        ...
                        <div class="pt-4">
                            ...
                            <p class="text-[8px] text-slate-400 font-bold uppercase text-center mt-4 tracking-widest">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-6">
                            ...
                            <div class="md:col-span-2 space-y-2">
                                ...
                                <div class="relative max-w-sm">
                                    <select name="location" required {{-- Trik Atribut Size: Saat diklik, munculkan 5
                                        opsi saja (scrollable) --}} onfocus='this.size=5;' onblur='this.size=1;'
            ...
            <div x-show="tab === 'aktivasi'" x-transition x-cloak
                ...
                <div class="bg-white p-4 md:p-8 rounded-[1.5rem] md:rounded-[2.5rem] border border-slate-200 shadow-sm">
                    <div class="flex items-center space-x-3 mb-6">
                        ...
                        <h2 class="text-base md:text-xl font-black uppercase italic">Permintaan Aktivasi NIK
                        </h2>
                    </div>
            ...
            <div x-show="tab === 'proxy'" x-transition x-cloak>
                <div
                    ...
                    <div class="relative z-10">
                        <h2 class="text-xl md:text-2xl font-black mb-4 uppercase italic">Pelaporan Proxy
                        </h2>
                        <p
                        ...
                        <form action="{{ route('proxy.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div x-data="{ proxyPreview: null }">
                                <label class="text-[10px] font-black text-indigo-200 uppercase ml-2 block mb-2">Bukti
                                    Screenshot</label>
                                <input type="file" name="foto_proxy" class="hidden" x-ref="proxyFile" accept="image/*"
                                    required
                                ...
                                <div @click="$refs.proxyFile.click()"
                                    ...
                                    <div x-show="proxyPreview" x-cloak class="flex flex-col items-center">
                                        <img :src="proxyPreview" class="h-32 rounded-lg border border-white/20 mb-2">
                                        <span
            ...
            <div x-show="tab === 'trouble'" x-transition x-cloak>
                <div class="bg-red-50 p-6 md:p-10 rounded-[2rem] md:rounded-[2.5rem] border border-red-200 shadow-sm">
                            ...
                            <div x-data="{ 
                                ...
                                <div @click="$refs.troubleFile.click()"
                                    ...
                                    <div x-show="previews.length > 0" x-cloak
                                        ...
                                        <template x-for="(img, index) in previews" :key="index">
                                            <img :src="img" class="h-8 w-8 rounded object-cover border border-red-200">
                                        </template>
