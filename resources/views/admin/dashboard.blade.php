...
<body class="bg-slate-50 min-h-screen" x-data="{ tab: 'dashboard' }">
    ...
    editData: { id: '', name: '', email: '', location: '', role: '', pin: '' } 
                    ...
                    @if(session('success'))
                        <div
                            class="bg-green-50 border-l-4 border-green-500 p-4 mb-4 rounded-xl shadow-sm flex items-center">
                    ...
                    <div
                        ...
                        <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label
                                        class="text-[10px] font-black text-slate-400 uppercase ml-2 block mb-1">Lokasi
                                        Kecamatan</label>
                                    <div class="relative group">
                                        <input list="list_kecamatan" name="location" required
                                            value="{{ old('location') }}" placeholder="Pilih atau cari kecamatan..."
                                            ...
                                            <td class="p-4 md:p-5">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div class="min-w-0">
                                                        ...
                                                        <p
                                                            class="text-[9px] md:text-[10px] text-slate-400 font-medium italic">
                                                            PIN:
                    ...
                    <div x-show="editModal"
                        ...
                        <div @click.away="editModal = false"
                            ...
                            <div class="flex justify-between items-center mb-6 border-b border-slate-100 pb-4">
                                <h2 class="text-lg md:text-xl font-black uppercase italic text-slate-800">Edit Pengguna
                                </h2>
                            ...
                            <form :action="'/admin/users/' + editData.id + '/update'" method="POST" class="space-y-4">
                                ...
                                <div>
                                    <label
                                        class="text-[10px] font-black text-slate-400 uppercase block mb-1 ml-2">Lokasi
                                        Kecamatan</label>
                    ...
                    <div x-show="showModal"
                        ...
                        <div class="relative max-w-5xl w-full" @click.stop>
                            ...
                            <div class="bg-white p-2 rounded-[2rem] shadow-2xl overflow-hidden">
                                <img :src="modalImage"
                                    class="w-full h-auto max-h-[75vh] object-contain rounded-[1.5rem]">
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tr class="hover:bg-slate-50/50 transition-all"
                                            ...
                                            <td class="p-8">
                                                ...
                                                <div
                                                    ...
                                                    <span x-text="row.date_human"></span> • <span
        ...
        return monthMatch && typeMatch && statusMatch && kecMatch;
                                        ...
                                        <tr x-show="shouldShow('{{ $l->type }}', '{{ $createdAt->format('Y-m-d') }}', '{{ $status }}', '{{ $namaKecamatan }}')"
                                            ...
                                            <td class="p-6">
                                                <div class="flex flex-col gap-2">
                                                    ...
                                                    <div>
                                                        <div
                                                            class="text-slate-900 font-black text-base italic leading-tight">
                                                            {{ $l->user_name }}
                                                        </div>
                                                        <div
                    ...
                    <div x-show="imgModal"
                        ...
                        <div class="relative w-full max-w-4xl mx-auto" @click.stop>
                            <div
                                class="absolute -top-10 left-0 right-0 flex justify-between items-center text-white px-1">
                                <span
